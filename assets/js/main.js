...
var sfApp={
            ...
            jQuery.each($newElements,function( i, val ){
                ...
                // Video Post By LINK
                    ...
                    if($videoEl.length){
                        var videoUrl=$videoEl.attr('href');
                        if(videoUrl!=''){
                            $postHeader.addClass('video-post');
                ...
                // Audio Post By Link
                    ...
                    $postHeader.addClass('audio-post');
                    $audio.scPlayer({
                        randomize: true
                    });
                    var $line = $postHeader.find('.line');
    ...
    audioPlayback:function(){
        $(document).on('click','.audio-playback', function(event) {
            var $this=$(this);
            var $postHeader=$this.closest('.post-header');
            var $playEl=$postHeader.find('.sc-player .player-container .sc-controls .playback .sc-play');
            var $pauseEl=$postHeader.find('.sc-player .player-container .sc-controls .playback .sc-pause');
            if(!$this.is('.playing')){
